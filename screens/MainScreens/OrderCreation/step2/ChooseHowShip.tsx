              ...
              >
                ...
                <View className="px-4 pt-5 flex flex-col gap-1">
                  ...
                  <View className="flex flex-row pt-2 pb-4">
                    <View className="flex flex-col gap-2 justify-start items-center w-1/3 py-2">
                      <View className="h-12 w-12 bg-[#E4E8EF] flex justify-center items-center rounded-full">
                        <Icon name="Dollar" size={26} />
                      </View>

                      <Text className="text-primary/80 font-inter-medium text-[13px] text-center">
                        Cost Efficient
                      </Text>
                    </View>
                    <View className="h-20 my-auto w-0.5 rounded-full bg-primary/20" />
                    <View className="flex flex-col gap-2 justify-start items-center w-1/3 py-2">
                      <View className="h-12 w-12 bg-[#E4E8EF] flex justify-center items-center rounded-full">
